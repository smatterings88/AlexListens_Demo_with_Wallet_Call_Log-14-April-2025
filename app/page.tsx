...
export default function Home() {
  ...
  const handleStartCallButtonClick = useCallback(async (modelOverride?: string, showDebugMessages?: boolean) => {
    ...
    if (!minutesWallet || minutesWallet.minutes <= 0) {
    ...
    try {
      ...
      const callConfig: CallConfig = {
        ...
        maxDuration: `${minutesWallet.minutes * 60}s`,
                      ...
                      <div className="flex justify-between items-center mb-4 sm:mb-8">
                        ...
                        {minutesWallet && (
                          <div className="text-lg font-medium">
                            Minutes remaining: <span className="text-[#004AAA]">{minutesWallet.minutes}</span>
                          </div>
                        )}
                      </div>
                          ...
                          {isCallActive ? (
                            ...
                            <>
                              ...
                              <button
                                ...
                                disabled={!user || !minutesWallet || minutesWallet.minutes <= 0}
                              >
                                {!user ? 'Sign in to Start' : 
                                 !minutesWallet || minutesWallet.minutes <= 0 ? 'No Minutes Available' : 'Start'}
                              </button>
                            </>
                          )}
                        </div>
